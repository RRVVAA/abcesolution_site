                                ...
                                <div class="rows">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" name="empresa" value="{{old('empresa')}}" required
                                               class="form-campo required" name="empresa">
                                    </div>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="email" name="email" value="{{old('email')}}" required
                                               class="form-campo required" name="nome_completo">
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class=" mb-3">
                                            ...
                                            <input type="text" name="celular" value="{{old('celular')}}" required
                                                   minlength="10" maxlength="17" name="telefone"
                                                   class="mascara_tel form-campo mascara-fone required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="password" name="senha" value="{{old('senha')}}" required
                                                   class="form-campo required" name="senha">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class=" mb-3">
                                            ...
                                            <select class="form-campo" name="conheceu" required>
                                                ...
                                                <option value="influenciadores">Influenciadores ou Redes Sociais
                                                </option>
